...
<h1>프로젝트 소개</h1>
본 프로젝트는 파킨슨병, 뇌졸중 등과 같은 퇴행성 뇌질환에 의한 손의 기능 저하로<br> 
훈련이 필요한 환자들을 위한 시스템으로 손가락 기능 개선 훈련 및 손가락 힘의 정량적인 측정을 위하여<br>
FSR(Force Sensing Resistor) 힘 센서를 활용한 디바이스 및 콘텐츠를 지작한다.<br>
